    ...
    return __generator(this, function (_a) {
        describe('merging ' + combination.name, function () {
            ...
            describe('errors', function () {
                ...
                it('should preserve custom error extensions from the original schema, ' +
                    'when merging schemas', function () { return __awaiter(_this, void 0, void 0, function () {
                    var propertyQuery, propertyResult, mergedResult;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                propertyQuery = "\n            query {\n              properties(limit: 1) {\n                error\n              }\n            }\n          ";
                                return [4 /*yield*/, graphql_1.graphql(propertySchema, propertyQuery)];
                            case 1:
                                propertyResult = _a.sent();
                                return [4 /*yield*/, graphql_1.graphql(mergedSchema, propertyQuery)];
                            case 2:
                                mergedResult = _a.sent();
                                [propertyResult, mergedResult].forEach(function (result) {
                                    chai_1.expect(result.errors).to.exist;
                                    chai_1.expect(result.errors.length > 0).to.be.true;
                                    var error = result.errors[0];
                                    chai_1.expect(error.extensions).to.exist;
                                    chai_1.expect(error.extensions.code).to.equal('SOME_CUSTOM_CODE');
                                });
                                return [2 /*return*/];
                        }
                    });
